...
function main() {
  ...
  const manifest = { schemaVersion: 4, authorityRole: "candidate", lifecycleState: "CANDIDATE_VALIDATED", artifact: { artifactId: "paperlens-question-corpus", artifactVersion: "synthetic-v1", artifactPath: evidence.artifact.path, sizeBytes: 1, sha256: artifactSha, recordCount: 1, stableIdSetSha256: stableSha }, scope: { supportedSyllabi: ["0478"], scopeSha256: scopeSha }, schema: { artifactSchemaId: evidence.schema.id, artifactSchemaVersion: 1, artifactSchemaPath: evidence.schema.path, artifactSchemaSha256: evidence.schema.sha256 }, provenance: { sourceCommit, generatedAt, generator: { id: "paperlens-promotion-manifest-generator", version: "1.0.0", registryPath: c.generatorRegistry.path, registrySha256: c.generatorRegistry.byteSha256 }, manifestHistoryEvidence: { evidencePath: "promotion/candidate/evidence/manifest-history.json", evidenceSha256: "5".repeat(64) } }, validation: { result: "PASS", validatedAt: generatedAt, evidencePath: "promotion/candidate/evidence/validation.json", evidenceProjectionProfile: c.hashBindingModel.evidenceProjection.profileId, evidenceProjectionSha256: projectionSha }, promotion: { mode: null, baselineProductionSha256: null, differenceRequestPath: null, differenceRequestSha256: null, approvalEvidencePath: null, approvalEvidenceSha256: null, runtimeRemoteHistoryEvidencePath: null, runtimeRemoteHistoryEvidenceSha256: null, reviewDecision: "NOT_APPLICABLE", reviewer: null, reviewedAt: null, promotionId: null } };
